...
from .views import login_view, logout_view, dashboard, invitations, objects_page, notifications, users, visits, memos, laboratory, maintenance, deliveries, reports, api_create_ticket, api_get_tickets, api_reply_ticket, api_get_memos, api_create_memo, api_get_all_memos, api_user_objects, api_object_detail
...
urlpatterns = [
    ...
    path("api/memos/all/", api_get_all_memos, name="api_get_all_memos"),
